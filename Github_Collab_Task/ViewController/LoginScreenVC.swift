...
class LoginScreenVC: UIViewController {
    ...
    @IBAction func OnClickLogin(_ sender: Any) {
        ...
        else if (TfEmail.text?.lowercased() != UserDefaults.standard.string(forKey: "Email") || TfPassword.text != UserDefaults.standard.string(forKey: "Password")){
...
//        ShowAlertBox(Title: "Login Successfull!", Message: "")
        ...
        let HomeScreenObj = UIStoryboard(name: "Main", bundle: nibBundle).instantiateViewController(withIdentifier: "CustomTabbarController") as! CustomTabbarController
